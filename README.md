...
4.  **Verifica Rilevamento:** Attiva **"Mostra Box Rilevamento"** per visualizzare i rettangoli di tracking e assicurarti che l'IA stia identificando correttamente i target.
5.  **Gestione Dati:** Usa il tasto **AZZERA CONTEGGI** per resettare le statistiche mantenendo le zone configurate.
